...
$env:CLAROS_STORAGE_BACKEND='local'
...
The offline fixture is hash-bound and deterministically validated before use;
it is not model output. With funded API access, unset `CLAROS_DEMO_MODE` and
use the normal live compiler path. Typed interaction is the guaranteed path; microphone or
