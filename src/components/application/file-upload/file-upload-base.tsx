...
interface FileUploadDropZoneProps {
  ...
  hint?: string;
  /**
   * The visible label for the file-picker button.
   */
  buttonLabel?: string;
  /**
   * The accessible label for the hidden file input.
   */
  inputLabel?: string;
  /**
   ...
   */
  isDisabled?: boolean;
  /** Whether an externally controlled validation error is active. */
  isInvalid?: boolean;
  /** Element that explains the active validation error. */
...
export const FileUploadDropZone = ({
  ...
  return (
    <div
      data-dropzone
      aria-invalid={isInvalid || isExternallyInvalid || undefined}
      aria-describedby={
        isInvalid || isExternallyInvalid ? errorMessageId : undefined
      }
    ...
    >
      ...
      <div className="flex flex-col gap-1 text-center">
        ...
        <p
          className={cx(
            "text-[13px] transition duration-100 ease-linear",
